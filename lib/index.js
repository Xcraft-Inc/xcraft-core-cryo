...
class Cryo {
  ...
  _open(dbName) {
    ...
    const queries = {
      create: `CREATE TABLE IF NOT EXISTS actions (timestamp TEXT, goblin TEXT, action JSON)`,
      index: `CREATE INDEX IF NOT EXISTS ripley ON actions (goblin, timestamp DESC)`,
